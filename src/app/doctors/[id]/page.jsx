  ...
  if (!doctor) {
    return (
      <div className="text-center py-32">
        <h2 className="text-3xl font-bold">Doctor Not Found</h2>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="p-10 flex flex-col justify-center">
              ...
              <p className="text-[#0055CC] text-xl mt-3 font-medium">
                {doctor.specialty}
              </p>
              ...
              <button
                onClick={() => setShowModal(true)}
                className="mt-8 bg-[#0055CC] text-white py-4 rounded-2xl font-bold hover:bg-blue-700 transition"
              >
                Book Appointment
              </button>
            </div>
